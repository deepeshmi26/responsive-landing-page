...
function App() {
  return (
      <div className = "w-full h-screen bg-[#e9af4b] overflow-y-scroll snap-y snap-mandatory">
        <div className="w-full h-full flex items-center justify-center  snap-start px-4 py-2">
          <div className="container h-full flex flex-col lg:flex-row gap-y-8 items-center justify-center">
            ...
            <h1 className="text-6xl leading-normal font-bold mb-4 break-keep">
              Lorem Ipsum is simply dummy text. Yes it is just dummy
                </h1>
                <p className="mb-4 2xs:max-xs:hidden font-normal leading-normal text-gray-500 ">
                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                </p>
            </div>
            <div className="flex-grow 2xs:max-xs:hidden block overflow-hidden relative w-full h-full ">
                <img
        ...
        <div className="w-full h-full 2xs:max-xs:flex hidden  items-center justify-center  snap-start px-4 py-2">
          <div className="container h-full flex flex-col lg:flex-row gap-y-8 items-center justify-center">
